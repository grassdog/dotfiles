...
(custom-set-variables
 ...
 '(haskell-tags-on-save nil)
  '(package-selected-packages
     (quote
       (csv-mode sly ox-slack diminish ivy-prescient lsp-clients company-lsp lsp-ui lsp-mode doom-themes doom-modeline all-the-icons rspec-mode prescient restclient rust-mode web-mode rjsx-mode pandoc-mode which-key tide beacon beacon-mode magit-popup deadgrep kotlin-mode grab-mac-link org-re-reveal rufo feature-mode osx-dictionary tss evil-collection cider slim-mode pcre2el flyspell-correct-ivy flyspell-correct-popup jq-mode nov prettier-js dumb-jump nlinum-hl flycheck-flow flow-minor-mode emamux evil-terminal-cursor-changer magit-gh-pulls magithub highlight-indent-guides emojify graphviz-dot-mode window-numbering ripgrep docker-tramp intero flymake-json evil-org cider-eval-sexp-fu projectile-rails evil-indent-plus evil-args syslog-mode toml-mode vagrant mmm-mode markdown-toc gist dockerfile-mode github-browse-file eshell-prompt-extras ruby-end company-ghc hindent flycheck-pos-tip counsel-projectile flycheck evil-magit terraform-mode origami drag-stuff company elixir-mode clojure-mode haskell-mode rbenv js2-mode org-bullets git-link peep-dired ivy-hydra flx-ido counsel evil-anzu keyfreq evil-search-highlight-persist evil-visualstar evil-surround evil-matchit evil-commentary evil ivy hydra general git-gutter zop-to-char zenburn-theme yaml-mode ws-butler web-beautify volatile-highlights use-package undo-tree typescript-mode string-inflection spacemacs-theme spaceline smartparens simpleclip scss-mode reveal-in-osx-finder rainbow-mode rainbow-delimiters puppet-mode powershell ox-reveal ox-pandoc org-mac-link nlinum move-text markdown-mode magit json-mode js2-refactor jade-mode inf-ruby ignoramus iedit ido-vertical-mode ibuffer-vc htmlize highlight-indentation hi2 helm-swoop helm-flycheck helm-ag haml-mode goto-chg git-timemachine git-gutter-fringe ghc flycheck-tip flycheck-elm flycheck-clojure expand-region exec-path-from-shell enh-ruby-mode elm-mode dired-single dired-ranger dired-rainbow dired-open dired-filter dired+ crux corral coffee-mode clojure-snippets clj-refactor chruby char-menu browse-kill-ring anzu alchemist ag ace-window)))
